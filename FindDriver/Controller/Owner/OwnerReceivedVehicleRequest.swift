...
class OwnerReceivedVehicleRequest: UITableViewController {
    ...
    @IBAction func acceptRequest(_ sender: UIButton) {
        ...
        let driverAutoGeneratedKey = vehicleArray[vehicleIndex].driverAutoGeneratedKey
        let driverIndexPathInFirebase = ref?.child("profiles").child(driverAutoGeneratedKey)
        
        let dictionaryValue2 = ["vehicleAutoGeneratedKey": vehicleAutoGeneratedKey, "ownerID": Auth.auth().currentUser?.uid]
