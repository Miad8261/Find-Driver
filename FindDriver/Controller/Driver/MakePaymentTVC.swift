...
class MakePaymentTVC: UITableViewController {
    ...
    @IBOutlet var driverMessageToOwner: UITextView!
    ...
    @IBAction func sendPaymentButton(_ sender: UIBarButtonItem) {
        ...
        let vehicleDictionary = [ "startDate": startDate, "endDate": endDate, "amount": amountToPay, "driverID": driverInstance.driverID, "paymentConfirmed": false, "driverAutoGenerateKey": driverInstance.driverAutoGenerateKey, "ownerID": driverInstance.ownerID, "vehicleAutoGeneratedKey": driverInstance.vehicleAutoGeneratedKey, "driverPhone": driverInstance.phone, "driverMessage": driverMessageToOwner.text] as [String : Any]
