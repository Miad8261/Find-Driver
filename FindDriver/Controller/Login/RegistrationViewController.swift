...
class RegistrationViewController: UIViewController {
    ...
    @IBAction func ownerButtonPressed(_ sender: UIButton) {
        ...
        Auth.auth().createUser(withEmail: emailTextfield.text!, password: passwordTextfield.text!) { (user, error) in
            ...
            if error != nil {
                print(error!)
                ProgressHUD.showError("Siggned up failed, try again.")
            } else {
                ...
                ProgressHUD.showSuccess("Siggned up success!")
    ...
    func saveDriverInformation(){
        ...
        let messageDictionary = ["personID": Auth.auth().currentUser?.uid, "driverID": Auth.auth().currentUser?.uid,"firstName": self.firstNameTextfield.text!, "lastName": self.lastNameTextfield.text!, "email": self.emailTextfield.text!, "phone": self.phoneTextfield.text!, "city": self.cityTextfield.text!,"type": "driver", "ownerID": "", "vehicleAutoGeneratedKey": ""]
